                ...
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="servo1-group">
                            ...
                            <div class="range-min">11</div>
                            <input type="range" id="servo1" min="325" max="650" value="487" class="default-action">
                            <div class="range-max">650</div>
                        </div>
                        <!--
                        <div class="input-group" id="servo2-group">
                            <label for="servo2">Servo2</label>
                            <div class="range-min">11</div>
                            <input type="range" id="servo2" min="10" max="170" value="90" class="default-action">
                            <div class="range-max">169</div>
                        </div>
                        -->
...
static esp_err_t cmd_handler(httpd_req_t *req){
    ...
    if(!strcmp(variable, "framesize")) {
      ...
      #define LED_BUILTIN 4
        ...
        //Servo myservox;
        //Serial.println("servo1a");
        //myservox.attach(2);
        //Serial.println("servo1b");
        //myservox.write(atoi(value));
        //Serial.println("servo1c");
        //myservox.detach();
...
void startCameraServer(){
   ...
   httpd_uri_t stream_uri = {
    ...
    config.server_port =81;//stream port + also change this in the html-source in this file
